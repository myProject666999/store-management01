                ...
                <el-col :span="20">
                    <el-table
                        ...
                        <el-table-column
                            ...
                            <template slot-scope="scope">{{ scope.row.produce_date }} - {{ scope.row.expiry_date }}</template>
                        </el-table-column>
                        ...
                        <el-table-column
                            ...
                            <template slot-scope="scope">{{ scope.row.check_num ? scope.row.check_num : scope.row.apply_num }}</template>
                        </el-table-column>

                        <el-table-column
                            :label="$t('billDetails.auditPrice')">
                            <template slot-scope="scope">{{ scope.row.check_price ? scope.row.check_price : scope.row.pre_price }}</template>
                        </el-table-column>
                    </el-table>
